<div class="card card-primary card-outline text-sm">
    ...
    <div class="card-body card-slug">
        ...
        <div class="form-gourp mb-0">
            <label class="d-block">Đường dẫn mẫu:<span class="pl-2 font-weight-normal" id="slugurlpreview"><?= $configBase ?><strong class="text-info"><?= @$item['slug'] ?></strong></span></label>
            <input type="text" class="form-control slug-input no-validate text-sm" name="slug" id="slug" placeholder="Đường dẫn" value="<?= @$item['slug'] ?>" required>
            <input type="hidden" id="slug-default" value="<?= @$item['slug'] ?>">
