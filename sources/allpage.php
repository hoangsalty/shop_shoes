...
$splistht = $d->rawQuery("select * from table_product_list where find_in_set('hienthi',status) order by id desc");
...
$policy = $d->rawQuery("select * from table_news where find_in_set('hienthi',status) and type = ? order by id desc", array('chinh-sach'));
