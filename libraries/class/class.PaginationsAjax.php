    ...
    function getAllPageLinks($count, $href, $elShow)
    {
        ...
        if ($pages > 1) {
            if ($_GET["page"] == 1)
                ...
                $output = $output . '<a class="first" onclick="loadPaging(\'' . $href . (1) . '\',\'' . $elShow . '\')" >First</a><a class="prev" onclick="loadPaging(\'' . $href . ($_GET["page"] - 1) . '\',\'' . $elShow . '\')" >Prev</a>';
            ...
            if ($_GET["page"] < $pages)
                $output = $output . '<a class="next" onclick="loadPaging(\'' . $href . ($_GET["page"] + 1) . '\',\'' . $elShow . '\')" >Next</a><a class="last" onclick="loadPaging(\'' . $href . ($pages) . '\',\'' . $elShow . '\')" >Last</a>';
            else
