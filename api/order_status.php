...
$currentOrder = (!empty($_POST['currentOrder'])) ? $_POST['currentOrder'] : array();
$tempCart = (!empty($_POST['tempCart'])) ? $_POST['tempCart'] : array();
$messages = (!empty($_POST['messages'])) ? $_POST['messages'] : '';
$statusOrder = (!empty($_POST['statusOrder'])) ? $_POST['statusOrder'] : '';
?>
...
<div class="payment-content redirect-info">
    ...
    <div class="item-info error">
        ...
        <span style="color: <?= $statusOrder == 200 ? '#63C000' : '#f5222d' ?>;"><?= $messages ?></span>
    </div>
